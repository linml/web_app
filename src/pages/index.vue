...
.nav-footer {
    ...
    footer {
      ...
      a {
        ...
        .tab-1 {
          background-image: url("../assets/imgs/hall-noselect.svg");
        }
        .tab-2 {
          background-image: url("../assets/imgs/history-noselect.svg");
        }
        .tab-3 {
        ...
        &.router-link-active.active {
          ...
          .tab-1 {
            background-image: url("../assets/imgs/hall-select.svg");
          }
          .tab-2 {
            background-image: url("../assets/imgs/history-select.svg");
          }
          .tab-3 {
